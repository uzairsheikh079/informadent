            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 text-right">
                        <a href="{{ route('clinics.create') }}" class="btn btn-sm btn-success">ADD CLINIC</a>
                    </div>
                </div>
                 <div class="row">
                                <div class="col-md-6">
                                    <div class="dataTables_lenght" id="datatables_length">
                                        <label>Showing
                                        <form action="{{ route('clinics.index') }}" method="GET" role="search">
                                            ...
                                            <span class="bmd-form-group bmd-form-group-sm">
                                                <form action="{{ route('clinics.index') }}" method="GET"
                                                    ...
                                                    <input type="search" class="form-control form-control-sm"
                                                        name="clinic_name" id="clinic_name" placeholder="Search clinics"
                                ...
                                <div class="col-sm-12">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover dataTable no-footer dtr-inline" role="grid" aria-describedby="datatables_info" class="table table-hover">
                                        ...
                                        <tr role="row">
                                            ...
                                            <th style="font-weight:bold">Clinic</th>
                                    ...
                                    @foreach ($clinics as $key => $clinic)
                                          <tr role="row" class="odd">
                                            ...
                                            <form action="{{ route('clinics.destroy', $clinic->id) }}" method="POST">
                                                <a type="button" rel="tooltip" title="Show" href="{{ route('clinics.show', $clinic->id) }}" class="btn btn-warning glyphicon glyphicon glyphicon-eye-open">
                                                <i class="material-icons">visibility</i>
                                              </a>
                                                <a type="button" rel="tooltip" title="Edit" href="{{ route('clinics.edit', $clinic->id) }}" class="btn btn-info glyphicon glyphicon glyphicon-eye-open">
...
<script> 
    function submitForm() {
        var searchData = $("#clinic_name").val();
