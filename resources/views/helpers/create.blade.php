...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
    <form method="POST" action="{{ route('helpers.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
    <div class="card ">
              <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title">Add Helper</h4>
              </div>
              <div class="card-body ">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <input class="form-control" name="helper_name" type="text" placeholder="{{ __('helper...') }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-primary">{{ __('ADD HELPER') }}</button>
              </div>
        </div>
        </form>
            </div>
