...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
    <form method="POST" action="{{ route('diagnose.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
    <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <input class="form-control" name="diagnose_name" type="text" placeholder="{{ __('diagnose...') }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                        <select  class="custom-select custom-select-md" name="parent_id" required="true" aria-required="true">
                            <option selected disabled>Select Parent Diagnose</option>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <select class="custom-select custom-select-md" name="degree">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-rose">{{ __('ADD DIAGNOSE') }}</button>
              </div>
        </div>
        </form>
            </div>
