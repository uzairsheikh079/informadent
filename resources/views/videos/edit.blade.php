...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              <form method="POST" action="{{ route('videos.update', $video->id) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data"> 
              @csrf
              @method('put')
              <div class="card ">
                  ...
                  <div class="col-sm-8 text-center">
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                      <div class="fileinput-new thumbnail img-square">
                        <video id="target" style="border-radius: 8%;" width="200">
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <input class="form-control" name="id" type="text" value="{{ $video->id }}" disabled> 
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <input class="form-control" name="video_name" type="text" value="{{ $video->video_name }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <input class="form-control" name="video_title" type="text" value="{{ $video->video_title }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <input class="form-control" name="video_category" type="text" value="{{ $video->video_category }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <textarea class="summernote" cols="30" rows="5" name="privately_insured_cuecard_description">{{ $video->privately_insured_cuecard_description }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <textarea class="summernote" cols="30" rows="5" name="privately_insured_patient_short_description">{{ $video->privately_insured_patient_short_description }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <textarea class="summernote" cols="30" rows="5" name="privately_insured_patient_long_description">{{ $video->privately_insured_patient_long_description }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <textarea class="summernote" cols="30" rows="5" name="privately_insured_doctor_long_description">{{ $video->privately_insured_doctor_long_description }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <textarea class="summernote" cols="30" rows="5" name="legaly_insured_cuecard_description" >{{ $video->legaly_insured_cuecard_description }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <textarea class="summernote" cols="30" rows="5" name="legaly_insured_patient_short_description" >{{ $video->legaly_insured_patient_short_description }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <textarea class="summernote" cols="30" rows="5" name="legaly_insured_patient_long_description">{{ $video->legaly_insured_patient_long_description }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <textarea class="summernote" cols="30" rows="5" name="legaly_insured_doctor_long_description">{{ $video->legaly_insured_doctor_long_description }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
