...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
    <form method="POST" action="{{ route('peoplepresentat.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
    <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <input class="form-control" name="ppa_name" type="text" placeholder="{{ __('people......') }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-warning">{{ __('ADD PEOPLE') }}</button>
              </div>
        </div>
        </form>
            </div>
