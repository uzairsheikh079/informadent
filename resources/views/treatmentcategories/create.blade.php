...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              <form method="POST" action="{{ route('treatmentcategories.store') }}" autocomplete="off" class="form-horizontal">
              @csrf
              <div class="card ">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h4 class="card-title">Add Treatment Category</h4>
                </div>
                <div class="card-body ">
                  <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <input class="form-control" name="treatmentcategory_name" type="text" placeholder="{{ __('treatment category...') }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
              <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <select class="custom-select custom-select-md" name="treatmentmodule_id">
                          <option selected disabled>Select Treatment Module</option>
                ...
                <div class="card-footer ml-auto mr-auto">
                  <button type="submit" class="btn btn-success">{{ __('ADD TREATMENT CATEGORY') }}</button>
                </div>
              </div>
              </form>
            </div>
