...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <form method="POST" action="{{ route('patientconsents.update',$patientconsent->id) }}" autocomplete="off" class="form-horizontal">
          @csrf
          @method('PUT')
        <div class="card ">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group"> 
                  <input class="form-control" name="id" type="text" value="{{ $patientconsent->id  }}" disabled>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group">
                  <input class="form-control" name="consent_name" type="text" value="{{ $patientconsent->consent_name  }}" required="true" aria-required="true"/>
                </div>
              </div>
            </div>
          </div>
          <div class="card-footer ml-auto mr-auto">
            <button type="submit" class="btn btn-success">{{ __('UPDATE PATIENT CONSENT') }}</button>
          </div>
        </div>
        </form>
      </div>
